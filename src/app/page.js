...
export default function Home() {
  return (
    <>
    <section className="bg-blue-600 m-auto text-center p-8">
      <h1 className="text-[5vw] font-semibold mb-8 w-fit lg:mx-48">Empowering Innovators. Bridging Challenges. Building Community</h1>
      <p className="w-1/2 m-auto my-8">Join a thriving network of hardware developers, founders, and AI engineers. Connect, collaborate, and unlock new opportunities</p>
      ...
      <div className="flex justify-between">
       ...
       <div className="text-center lg:mx-[25vw] bg-red-400"> <quote className="text-black text-2xl">"When we come together, we can overcome any challenge and create endless opportunities. That's the power of community."</quote>
